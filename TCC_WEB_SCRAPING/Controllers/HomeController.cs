...
#region Working
        ...
        private Dictionary<string,string> ParseHtml2(string html)
        {
        ...
        private void WriteToCsv2(Dictionary<string, string> Dict, Dictionary<string, string> Hours)
        {
